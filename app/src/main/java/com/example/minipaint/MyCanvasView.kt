...
class MyCanvasView(context : Context) : View(context) {
    ...
    private val paint = Paint().apply {
        ...
        isAntiAlias = true // Dithering affects how colors with higher-precision than the device are down-sampled.
        isDither = true
    ...
    override fun onSizeChanged(width: Int, height: Int, oldWidth: Int, oldHeight: Int) { //new width and height (to change to) and the old width and height (to change from)
    ...
    //This method draw the contents on the screen in this case draw the cached extraBitmap on the canvas associated with the view
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        //canvas.drawBitmap(extraBitmap, 0f, 0f, null) //the x and y coordinates
